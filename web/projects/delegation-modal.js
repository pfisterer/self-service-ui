...
import { TerminationDatePicker } from './component-common.js';
import { TokenEditor } from './component-token-editor.js';
import { useProjectConfig } from './projects.js';
import { UNLIMITED_QUOTA } from './util-project.js';
            ...
            <form onSubmit=${handleSubmit}>
                <${Stack}>
                    ...
                    <div>
                        ...
                        <${Grid}>
                            ${projectDefinitions.map((resource) => html`
