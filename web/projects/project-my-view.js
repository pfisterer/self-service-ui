...
import { ProjectDelegationsTable } from './component-common.js';
        ...
        <${Stack}>
            <${Group} justify="space-between" align="center" mb="md">
                ...
                <${Group} gap="sm" align="center">
                    ...
                    />
                    <${Button} size="xs" leftSection=${html`<${Plus} size="16"/>`} onClick=${() => setShowNewModal(true)}>
                        Create Project
                    <//>
                <//>
            <//>

            ${showAllocations && html`
            ...
            ${myRequests.length === 0 ? html`
                <${Text} c="dimmed" ta="center" py="xl">No project requests yet.<//>
            ` : html`
